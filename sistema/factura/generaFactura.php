<?php
	...
	if(empty($_REQUEST['cl']) || empty($_REQUEST['f']))
	{
		...
		$productos = mysqli_query($conexion, "SELECT d.nofactura, d.codproducto, d.cantidad, p.id_producto, p.descripcion, p.precio FROM detallefactura d INNER JOIN productos p ON d.nofactura = $noFactura WHERE d.codproducto = p.id_producto");
		...
		$pdf->SetFont('Arial', 'B', 7);
		$pdf->Cell(15, 5, "No. Factura: ", 0, 0, 'L');
		$pdf->SetFont('Arial', '', 7);
